    ...
    <div className="max-w-7xl mx-auto p-4 sm:p-6">
      ...
      {!orderDetails ? (
        ...
        <div className="p-4 sm:p-6 rounded-lg border">
          ...
          {/* customer , payments,shipping info */}
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-0 mb-8">
            <div>
          ...
          <div className="overflow-x-auto">
            <h4 className="text-lg-font-semibold mb-4">Product Lists</h4>
